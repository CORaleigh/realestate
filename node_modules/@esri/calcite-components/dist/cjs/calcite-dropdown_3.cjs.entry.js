...
const CalciteDropdownItem = class {
    constructor(hostRef) {
        ...
        this.calciteDropdownItemMouseover = core.createEvent(this, "calciteDropdownItemMouseover", 7);
    ...
    render() {
        ...
        const scale = dom.getElementProp(this.el, "scale", "m");
        if (!this.href) {
            return (core.h(core.Host, { theme: theme, dir: dir, scale: scale, id: this.dropdownItemId, tabindex: "0", role: "menuitem", "aria-selected": this.active ? "true" : "false" }, core.h("slot", null)));
        }
        else {
            return (core.h(core.Host, { theme: theme, dir: dir, scale: scale, id: this.dropdownItemId, tabindex: "0", role: "menuitem", "aria-selected": this.active ? "true" : "false", isLink: true }, core.h("a", { href: this.href, title: this.linktitle }, core.h("slot", null))));
        }
    }
    //--------------------------------------------------------------------------
    //
